...
#ifndef CLOUDSYNCAPP_SWIFT_H
#define CLOUDSYNCAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CloudSyncApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC12CloudSyncApp11AppDelegate")
...
SWIFT_CLASS("_TtC12CloudSyncApp19StatusBarController")
